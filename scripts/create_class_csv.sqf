...
private _csv = [["editor_subcategory", "editor_subcategory_displayName", "unit_class", "parent_class", "parent_parent_class", "uniform_class", "uniform_parent_class", "uniform_parent_parent_class"]];
